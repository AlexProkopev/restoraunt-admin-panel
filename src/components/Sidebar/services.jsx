import { BarChart, GroupOutlined, MenuBook, People, RateReview, Settings, ShoppingCart, TableRestaurant } from "@mui/icons-material";
...
export const menuItems = [
  ...
  { text: "Гости", icon: <GroupOutlined />, path: "/guests" },
